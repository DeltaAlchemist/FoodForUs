                ...
                <div className="item"><br/>
                    ...
                    <div className="content">
                        ...
                        <div className="description">
                            <button className="ui secondary button"  ><a href = "https://pebmed.com.br/ansiedade-e-o-transtorno-mais-comum-entre-os-brasileiros-durante-a-pandemia/" target = "_blank" style={{color: 'white'}}>Veja Mais!</a></button>
                        </div>
                    </div>
                </div> <br/><br/>
                <div className="item">
